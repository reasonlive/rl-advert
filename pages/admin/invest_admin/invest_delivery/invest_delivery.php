...
echo '<h3 class="sp" style="margin-top:0; padding-top:0;"><b>Рассылка сообщений пользователям на внутренню почту</b></h3>';
...
function AddDelivery() {
	...
	if (title == "") {
		...
		$.ajax({
			type: "POST", url: "invest_admin/invest_delivery/invest_delivery_ajax.php", 
