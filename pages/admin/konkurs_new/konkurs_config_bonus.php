...
$free_users = mysql_num_rows($mysqli->query("SELECT `id` FROM `tb_users` WHERE `referer`='' AND `user_status`='0' AND `not_get_ref`='0' AND `ban_date`='0'"));
...
if(count($_POST)>0) {
	...
	$konk_ads_count_prize = explode("; ", $sql->fetch_object()->price);
