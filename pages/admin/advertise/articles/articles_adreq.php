...
echo '<h3 class="sp" style="margin-top:0; padding-top:0;"><b>Неоплаченные заказы статей в каталог</b></h3>';

require("navigator/navigator.php");
$perpage = 20;
$sql_p = $mysqli->query("SELECT `id` FROM `tb_ads_articles` WHERE `status`='0'");
...
$sql = $mysqli->query("SELECT * FROM `tb_ads_articles` WHERE `status`='0' ORDER BY `id` DESC LIMIT $start_pos, $perpage");
if($sql->num_rows>0) {
