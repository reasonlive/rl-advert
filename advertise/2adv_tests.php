...
$(document).ready(function(){
	...
	$("#hint2").simpletip({
		...
		content: '<b>Инструкция для тестирования</b> - максимум 2000 символов.<br>Напишите, что необходимо предпринять прежде чем проходить тестирование, например просмотреть ваш сайт или прочитать статью. Соблюдайте грамматику. Небрежное написание оттолкнёт посетителей. Не пишите всё ЗАГЛАВНЫМИ БУКВАМИ, не ставьте множество однотипных знаков типа: !!!!!! и т.д. После запятой правильно ставить знак пробела. Уважайте читателей!'
	});
	$("#hint3").simpletip({
...
echo '<div id="InfoAds" style="display:block; align:justify; margin-bottom:6px;">';
	...
	echo '<span style="margin:7px auto; margin-bottom:50px; background:#F0F8FF; padding:8px; box-shadow:0 1px 2px rgba(0, 0, 0, 0.4); text-align:center; color:#E32636;">';
...
echo '<div id="newform" onkeypress="CtrlEnter(event);">';
	...
	echo '<tr>';
		...
		echo '<td align="left"><input type="text" id="money_add" maxlength="7" value="100" class="ok12"  onChange="PlanChange();" onKeydowm="PlanChange();" onKeyup="PlanChange();">&nbsp;&nbsp;(минимум - '.$tests_min_pay.' руб.)</td>';
